...
**OxShef: Charts** maintains a collection on tools to assist you in developing and designing effective visualisations, split into the following three categories:
...
These resources help choose the most effective data visualisation for the type, shape or amount of data that you have. In general, these resources can be readily used with any of the data viz tools listed by **OxShef: tools**.


Graphical perception theory in the 1980's
